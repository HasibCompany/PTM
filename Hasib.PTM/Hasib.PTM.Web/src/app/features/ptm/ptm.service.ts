...
export class PtmService {
  //private apiUrl = Settings.ptmUrl;
  ...
  checkAppActivate(appCode: any): Observable<any> {
    let url: string = `${Settings.ptmUrl}api/PTM/Settings/CheckAppActivate`;
    return this.http.get(url, { params: { appCode: appCode } });
  }
  // Permitions
  LoadPOPermit(paramsObj: any): Observable<any> {
    let url: string = `${Settings.ptmUrl}api/PTM/POPermit/LoadPOPermit`;
    return this.http.get(url, { params: paramsObj });
  }

  InsertPOPermit(paramsObj: any): Observable<any> {
    let url: string = `${Settings.ptmUrl}api/PTM/POPermit/InsertPOPermit`;
    return this.http.post(url, paramsObj, httpOptions);
  }

  UpdatePOPermit(paramsObj: any): Observable<any> {
    let url: string = `${Settings.ptmUrl}api/PTM/POPermit/UpdatePOPermit`;
    return this.http.put(url, paramsObj, httpOptions);
  }

  DeletePOPermit(paramsObj: any): Observable<any> {
    let url: string = `${Settings.ptmUrl}api/PTM/POPermit/DeletePOPermit`;
    return this.http.post(url, paramsObj, httpOptions);
  }
  //common
  LoadUserGroup(paramsObj: any): Observable<any> {
    let url: string = `${Settings.commonUrl}api/Common/UserGroup/LoadUserGroup`;
    return this.http.get(url, { params: paramsObj });
  }
  LoadProductUser(paramsObj: any): Observable<any> {
    let url: string = `${Settings.commonUrl}api/Common/ProductUser/LoadProductUser`;
    return this.http.get(url, { params: paramsObj });
  }
  LoadProfession(paramsObj: any): Observable<any> {
    let url: string = `${Settings.hrmUrl}api/HRM/Profession/LoadProfession`;
    return this.http.get(url, { params: paramsObj });
  }
