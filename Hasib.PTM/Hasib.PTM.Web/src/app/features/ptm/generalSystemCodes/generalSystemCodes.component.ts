...
@Component({
  selector: 'generalSystemCodes',
  templateUrl: './generalSystemCodes.component.html',
  styleUrls: ['./generalSystemCodes.component.scss']
})

export class GeneralSystemCodesComponent extends Base implements OnInit {
  t = Base.t;
  ...
  columns: DataTableColumn[] = [
    { field: 'purchaserID', header: 'PTM_CODE', controlType: 'textBox' },
    { field: 'purchaserNameEN', header: 'SHD_DESC_AR', controlType: 'textBox' }, 
    { field: 'fromDate', header: 'SHD_DESC_EN', controlType: 'textBox' },
    {
      field: 'toDate', header: 'SHD_IS_RESERVED', controlType: 'switch', defaultValue: true,
      renderText: (event) => {
        if (event.data === false)
    ...
    { field: 'toDate', header: 'PTM_ORDER', controlType: 'spinner'},
